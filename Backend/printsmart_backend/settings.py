"""
Django settings for PrintSmart Backend project.

A comprehensive print management system with file processing, 
...
ROOT_URLCONF = 'printsmart_backend.urls'
...
WSGI_APPLICATION = 'printsmart_backend.wsgi.application'
